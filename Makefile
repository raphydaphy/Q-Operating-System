...
CC:=gcc
#C coompiler flags
CFLAGS:=-m32 -ffreestanding -Wall -std=c99
...
all:
	...
	@ld -m elf_i386 -T $(DIR)/link.ld -o $(IMGDIR)/boot/kernel.bin $(ODIR)/kernel.asm.o $(ODIR)/kernel.o $(ODIR)/assemblyFunctions.o $(ODIR)/stringUtils.o $(ODIR)/screenUtils.o $(ODIR)/kbDetect.o
